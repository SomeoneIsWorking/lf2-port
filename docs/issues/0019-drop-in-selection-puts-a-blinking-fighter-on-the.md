...
VERIFIED on real frames, not by argument: scratch/hud19/frame_002306.png has the third panel lit with the candidate's portrait and full bars and TWO fighters on the stage; frame_002310.png, eight frames later, has that panel empty and the same two. The recorded co-op-selection scenario printed the gate byte from outside the HUD pass on every reported frame and rejected both a doctored '= 1' log and an empty log.
