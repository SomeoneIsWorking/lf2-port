...
void main(void)
{
    ...
    /* Everything that is not a character keeps its own pixels, minus whatever shadow falls
     * on it. That is the entire effect on the stage, the HUD and the text. */
    vec3 ground = albedo * shade;
