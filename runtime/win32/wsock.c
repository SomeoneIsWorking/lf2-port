...
static void h_fail1(void)
{
    ret_stdcall(1, SOCKET_ERROR);
}
static void h_fail2(void)
{
    ret_stdcall(2, SOCKET_ERROR);
}
static void h_fail3(void)
{
    ret_stdcall(3, SOCKET_ERROR);
}
static void h_fail4(void)
{
    ret_stdcall(4, SOCKET_ERROR);
}
static void h_fail5(void)
{
    ret_stdcall(5, SOCKET_ERROR);
}
static void h_null1(void)
{
    ret_stdcall(1, 0);
}
static void h_null2(void)
{
    ret_stdcall(2, 0);
}
static void h_ok0(void)
{
    ret_stdcall(0, 0);
}
static void h_ok1(void)
{
    ret_stdcall(1, 0);
}
static void h_ok4(void)
{
    ret_stdcall(4, 0);
}
...
Handler wsock_lookup(const char *dll, const char *name)
{
    ...
    static const struct {
        ...
        {"#52", h_gethostname}, {"#57", h_null2}, /* getservbyname */
        {"#101", h_ok4},                          /* WSAAsyncSelect */
        {"#115", h_WSAStartup}, {"#116", h_ok0},  /* WSACleanup    */
    };
