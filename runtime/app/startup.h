 ...
 * replacement settings UI is meant to own. Startup advances the guest's real top-level state
 * directly after its one-time initialisation and suppresses presentation until loading has
 * completed. The loader itself still runs unchanged.
 */
 ...
 * the game's top-level mode: 0 front end, 1 loader, 2 game proper. */
