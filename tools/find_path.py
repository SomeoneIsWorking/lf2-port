...
The menus are mouse-driven and each screen's clickable bands come from tools/click_bands.py.
...
Screen transitions are counted by runtime/ddraw.c's LF2_SCREEN_HASH, which compares a
