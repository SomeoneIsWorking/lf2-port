...
#
# Physical controllers are ignored when a scripted pad is configured, so the route owns its
# input slots and cannot be displaced by whatever is attached to the machine.
#
