...
ADOPTED_C_SOURCES = (
    ...
    ROOT / "runtime" / "cpu" / "guest.c",
    ROOT / "runtime" / "cpu" / "guest_map.h",
    ROOT / "runtime" / "cpu" / "guest_memory.c",
    ROOT / "runtime" / "cpu" / "guest_memory.h",
    ROOT / "runtime" / "cpu" / "guest_arena.c",
    ROOT / "runtime" / "cpu" / "guest_arena.h",
    ROOT / "runtime" / "win32" / "guest_heap.c",
    ROOT / "runtime" / "win32" / "guest_heap.h",
    ROOT / "runtime" / "win32" / "gdi_bitmap.c",
    ROOT / "runtime" / "win32" / "gdi_bitmap.h",
    ROOT / "runtime" / "video" / "surface_memory.c",
    ROOT / "runtime" / "video" / "surface_memory.h",
    ROOT / "runtime" / "video" / "frame_capture.c",
    ROOT / "runtime" / "video" / "frame_capture.h",
    ROOT / "runtime" / "video" / "ddraw.c",
    ROOT / "runtime" / "win32" / "com.c",
    ROOT / "runtime" / "win32" / "gdi.c",
    ROOT / "runtime" / "win32" / "imports.c",
    ROOT / "runtime" / "win32" / "wsock.c",
    ROOT / "runtime" / "input" / "gamepad.c",
    ROOT / "runtime" / "overrides" / "assets.c",
    ROOT / "runtime" / "overrides" / "coop_debug.c",
    ROOT / "runtime" / "video" / "engine_textures.c",
    ROOT / "tests" / "test_guest_memory.c",
    ROOT / "tests" / "test_gdi_bitmap.c",
